...
//     <button
//       onClick={onRetry}
//       className="rounded-lg bg-gradient-soft-purple700-pink500 px-4 py-1.5 text-xs font-semibold text-white transition-opacity hover:opacity-80"
//     >
//       Retry
//     </button>
//   </div>
...
//     // ADDED: Brand gradient fill — matches globals.css gradient-brand tokens
//     const gradient = ctx.createLinearGradient(0, 0, 0, 280);
//     gradient.addColorStop(0, "rgba(203, 12, 159, 0.30)");  // --color-primary
//     gradient.addColorStop(1, "rgba(126, 40, 202, 0.01)");  // brand purple
...
//             borderColor: "rgb(203, 12, 159)",   // --color-primary
//             borderWidth: 3,
//             pointBackgroundColor: "rgb(203, 12, 159)",
...
//           tooltip: {
//             // ADDED: Tooltip styled to match Soft UI card surface
//             backgroundColor: "rgba(255,255,255,0.97)",
//             borderColor: "rgba(203,12,159,0.20)",
//             borderWidth: 1,
...
//                 range === r
//                   ? "bg-gradient-soft-purple700-pink500 text-white shadow-sm"
